...
namespace GreenDelight.Persistence.Migrations
{
    ...
    [Migration("20250112141322_mig_add_new_example_project")]
    partial class mig_add_new_example_project
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GreenDelight.Domain.Concrete.TryEntities.VardiyaSablon", b =>
                {
                    b.Property<int>("VardiyaSablonId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("VardiyaSablonId"));

                    b.Property<short>("MaxVardiya")
                        .HasColumnType("smallint")
                        .HasColumnName("max_vardiya");

                    b.Property<string>("VardiyaSablonTanim")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)")
                        .HasColumnName("vardiya_sablon_tanim");

                    b.HasKey("VardiyaSablonId")
                        .HasName("PK_VardiyaSablon");

                    b.ToTable("vardiya_sablon", (string)null);
                });

            modelBuilder.Entity("GreenDelight.Domain.Concrete.TryEntities.VardiyaSablonIstasyonBirim", b =>
                {
                    b.Property<int>("VardiyaSablonIstasyonBirimId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("VardiyaSablonIstasyonBirimId"));
                    ...
                    b.Property<short?>("VardiyaSayisi")
                        .HasColumnType("smallint");

                    b.HasKey("VardiyaSablonIstasyonBirimId");

                    b.HasIndex("IstasyonBirimId");

                    b.HasIndex("VardiyaSablonId");

                    b.ToTable("VardiyaSablonIstasyonBirim");
                });

            modelBuilder.Entity("GreenDelight.Domain.Concrete.TryEntities.VardiyaSablonMasa", b =>
                {
                    b.Property<short>("VardiyaSablonMasaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
                        .HasColumnName("vardiya_sablon_masa_id");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<short>("VardiyaSablonMasaId"));
                    ...
                    b.Property<short?>("VardiyaSayisi")
                        .HasColumnType("smallint")
                        .HasColumnName("vardiya_sayisi");

                    b.HasKey("VardiyaSablonMasaId")
                        .HasName("PK_VardiyaSablonMasa");

                    b.HasIndex("MasaId");

                    b.HasIndex("VardiyaSablonId");

                    b.ToTable("vardiya_sablon_masa", (string)null);
                });
            ...
            modelBuilder.Entity("GreenDelight.Domain.Concrete.TryEntities.Vardiya", b =>
                {
                    b.HasOne("GreenDelight.Domain.Concrete.TryEntities.VardiyaSablon", "VardiyaSablon")
                        .WithMany("Vardiya")
                    ...
                    b.HasOne("GreenDelight.Domain.Concrete.TryEntities.VardiyaSablonYer", "VardiyaSablonYer")
                        .WithMany("Vardiya")
                        .HasForeignKey("VardiyaSablonId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("GreenDelight.Domain.Concrete.TryEntities.VardiyaSablonIstasyonBirim", b =>
                {
                    ...
                    b.HasOne("GreenDelight.Domain.Concrete.TryEntities.VardiyaSablon", "VardiyaSablon")
                        .WithMany("VardiyaSablonIstasyonBirim")
                        .HasForeignKey("VardiyaSablonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GreenDelight.Domain.Concrete.TryEntities.VardiyaSablon", b =>
                {
                    ...
                    b.Navigation("VardiyaSablonIstasyonBirim");
